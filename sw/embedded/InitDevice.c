...
extern void PORTS_0_enter_DefaultMode_from_RESET(void)
{
	...
	// open drain
	P0MDOUT = P0MDOUT_B0__OPEN_DRAIN | P0MDOUT_B1__OPEN_DRAIN		// N/C, N/C
			| P0MDOUT_B2__OPEN_DRAIN | P0MDOUT_B3__OPEN_DRAIN		// N/C, USER LED 1
			| P0MDOUT_B4__PUSH_PULL  | P0MDOUT_B5__OPEN_DRAIN		// SPI SCK, SPI SDI
			| P0MDOUT_B6__PUSH_PULL  | P0MDOUT_B7__PUSH_PULL;		// SPI_SDO, SPI_CS2_n

	// skip 0 to 3 so spi ends up on 4,5,6, skip CS2
	P0SKIP = P0SKIP_B0__SKIPPED      | P0SKIP_B1__SKIPPED			// N/C, N/C
		   | P0SKIP_B2__SKIPPED 	 | P0SKIP_B3__SKIPPED 			// N/C, USER LED 1
		   | P0SKIP_B4__NOT_SKIPPED  | P0SKIP_B5__NOT_SKIPPED		// SPI SCK, SPI SDI
		   | P0SKIP_B6__NOT_SKIPPED  | P0SKIP_B7__SKIPPED;			// SPI SDO, SPI_CS2_n
}
...
extern void PORTS_1_enter_DefaultMode_from_RESET(void)
{
	...
	// open drain
	P1MDOUT = P1MDOUT_B0__PUSH_PULL  | P1MDOUT_B1__OPEN_DRAIN		// SPI_CS1_n, I2C_SDA
			| P1MDOUT_B2__OPEN_DRAIN | P1MDOUT_B3__PUSH_PULL		// I2C_SCL, PWM_OE#
			| P1MDOUT_B4__OPEN_DRAIN | P1MDOUT_B5__OPEN_DRAIN		// N/C, N/C
			| P1MDOUT_B6__OPEN_DRAIN | P1MDOUT_B7__OPEN_DRAIN;		// N/C, N/C

	// skip 0 to 3 so spi ends up on 4,5,6
	P1SKIP = P1SKIP_B0__SKIPPED      | P1SKIP_B1__NOT_SKIPPED		// SPI_CS1_n, I2C_SDA
		   | P1SKIP_B2__NOT_SKIPPED  | P1SKIP_B3__SKIPPED 			// I2C_SCL, PWM_OE#
		   | P1SKIP_B4__SKIPPED      | P1SKIP_B5__SKIPPED		    // N/C, N/C
		   | P1SKIP_B6__SKIPPED      | P1SKIP_B7__SKIPPED;			// N/C, N/C
}
