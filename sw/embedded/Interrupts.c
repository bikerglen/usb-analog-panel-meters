...
extern uint8_t  NUM_BYTES_WR;          // number of bytes to write
                                       // Master -> Slave
extern uint8_t  NUM_BYTES_RD;          // number of bytes to read
                                       // Master <- Slave

// Global holder for SMBus data
// All receive data is written here
extern uint8_t SMB_DATA_IN[8];

// Global holder for SMBus data.
// All transmit data is read from here
extern uint8_t SMB_DATA_OUT[8];
